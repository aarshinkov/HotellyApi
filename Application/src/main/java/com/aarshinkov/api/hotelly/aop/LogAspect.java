package com.aarshinkov.api.hotelly.aop;
...
public class LogAspect {
    ...
    @Before("execution(* com.aarshinkov.api.hotelly.controllers.*.*(..)) "
            + "|| execution(* com.aarshinkov.api.hotelly.services.*.*(..))")
    ...
    @Around("execution(* com.aarshinkov.api.hotelly.controllers.*.*(..)) "
            + "|| execution(* com.aarshinkov.api.hotelly.services.*.*(..))")
